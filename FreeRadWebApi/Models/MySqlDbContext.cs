...
namespace FreeRadWebApi.Models
{
    ...
    public class MySqlDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserInGroup>().MapToStoredProcedures();
            ...
            modelBuilder.Entity<UserInGroup>().ToTable("radusergroup");
            modelBuilder.Entity<UserInGroup>().Property(ug => ug.UserName).HasColumnAnnotation("Index", new IndexAnnotation(new IndexAttribute("username")));

            modelBuilder.Entity<UserInGroup>().Property(ug => ug.UserName).IsRequired().HasMaxLength(64).IsUnicode(false);
            modelBuilder.Entity<UserInGroup>().Property(ug => ug.GroupName).IsRequired().HasMaxLength(64).IsUnicode(false);
            modelBuilder.Entity<UserInGroup>().Property(ug => ug.Priority).IsRequired();
            ...
            // AuthLog data annatation
            modelBuilder.Entity<AuthLog>().ToTable("radpostauth");
            modelBuilder.Entity<AuthLog>().Property(l => l.UserName).IsRequired().HasMaxLength(64).IsUnicode(false);
            modelBuilder.Entity<AuthLog>().Property(l => l.Pass).IsRequired().HasMaxLength(64).IsUnicode(false);
            modelBuilder.Entity<AuthLog>().Property(l => l.Reply).IsRequired().HasMaxLength(32).IsUnicode(false);
            modelBuilder.Entity<AuthLog>().Property(l => l.AuthDate).IsConcurrencyToken().HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed);
